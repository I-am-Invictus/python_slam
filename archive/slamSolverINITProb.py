...
ep[0] = (x0_0[0] * 1) - (x1_0[0] * W_o) #x0
ep[1] = (x0_0[1] * 1) - (x1_0[1] * W_o) #y0
...
ep[6] = L1[0] * W_m + L2[0] * W_m #Lx
ep[7] = L1[1] * W_m + L2[1] * W_m #Ly
